...
export class IsoAdapter {
  ...
  _makeTransparentTexture(scene, key, transColor) {
    ...
    // Use threshold for black (compression artifacts) vs exact match for magenta
    const isBlack   = tr < 10 && tg < 10 && tb < 10;
    const threshold = isBlack ? 15 : 0; // allow near-black to also be transparent
